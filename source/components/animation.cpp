...
void Animation::PlayAnimation(int fps, bool flip_sprites, int scroll_x, int scroll_y)
{
    ...
    NF_MoveSprite(m_spritesheet->m_screen, m_spritesheet->m_sprite_id, -(scroll_x - m_spritesheet->m_spr_pos->m_x), -(scroll_y - m_spritesheet->m_spr_pos->m_y));
}
